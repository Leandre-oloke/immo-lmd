...
// class MesLogements extends StatefulWidget {
//   @override
//   _MesLogementsState createState() => _MesLogementsState();
// }

// class _MesLogementsState extends State<MesLogements> {
//   final _titreController = TextEditingController();
//   final _prixController = TextEditingController();
//   final _vm = LogementViewModel();

//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text("Publier un logement")),
//       body: Padding(
...
//                   )
//                 );
//                 ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Logement publié !")));
//               },
//             ),
//           ],
//         ),
